...
var XpiInstaller = {
	...
	extFullName: 'Morse Code Interpreter', // The name displayed to the user (don't include the version)
	extShortName: 'morsecode', // The leafname of the JAR file (without the .jar part)
	extVersion: '0.1',
	extAuthor: 'Igor Birman',
